...
internal static class ClaimsPrincipalExtensions
{
    ...
    /// </summary>
    internal const string RT_EXP = "rt_exp";
    /// <summary>
    /// The claim type key for the fingerprint identifier.
    /// </summary>
    internal const string FP = "fp";
    ...
    internal static ClaimsPrincipal AddClaim(this ClaimsPrincipal user, string key, string value)
    {
        ArgumentNullException.ThrowIfNull(user, nameof(ClaimsPrincipal));
    ...
    /// <param name="key">Claim type/key.</param>
    /// <param name="value">Claim value.</param>
    internal static ClaimsPrincipal AddOrUpdateClaim(this ClaimsPrincipal user, string key, string value)
    {
        ArgumentNullException.ThrowIfNull(user, nameof(ClaimsPrincipal));
        ArgumentException.ThrowIfNullOrEmpty(key, nameof(key));
        ArgumentException.ThrowIfNullOrEmpty(value, nameof(value));
    ...
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="key">Claim type/key.</param>
    internal static ClaimsPrincipal RemoveClaim(this ClaimsPrincipal user, string key)
    {
        ArgumentNullException.ThrowIfNull(user, nameof(ClaimsPrincipal));
        ArgumentException.ThrowIfNullOrEmpty(key, nameof(key));
    ...
    internal static ClaimsPrincipal AddId(this ClaimsPrincipal user, string value) => user.AddClaim(ClaimTypes.NameIdentifier, value);
    /// <summary>
    ...
    internal static ClaimsPrincipal AddName(this ClaimsPrincipal user, string value) => user.AddClaim(ClaimTypes.Name, value);
    /// <summary>
    ...
    internal static ClaimsPrincipal AddEmail(this ClaimsPrincipal user, string value) => user.AddClaim(ClaimTypes.Email, value);
    /// <summary>
    ...
    internal static ClaimsPrincipal AddRole(this ClaimsPrincipal user, string value) => user.AddClaim(ClaimTypes.Role, value);
    /// <summary>
    ...
    internal static ClaimsPrincipal AddTenantId(this ClaimsPrincipal user, string value) => user.AddClaim(TENANT_ID, value);
    /// <summary>
    /// Gets the company identifier claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <returns>Company Id claim value or null.</returns>
    internal static string? GetCompanyId(this ClaimsPrincipal user) => user.GetClaim(COMPANY_ID);
    /// <summary>
    /// Adds a company identifier claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Company Id value.</param>
    internal static ClaimsPrincipal AddCompanyId(this ClaimsPrincipal user, string value) => user.AddClaim(COMPANY_ID, value);
    /// <summary>
    /// Gets the department claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <returns>Department claim value or null.</returns>
    internal static string? GetDepartment(this ClaimsPrincipal user) => user.GetClaim(DEPARTMENT);
    /// <summary>
    /// Adds a department claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Department value.</param>
    internal static ClaimsPrincipal AddDepartment(this ClaimsPrincipal user, string value) => user.AddClaim(DEPARTMENT, value);
    /// <summary>
    /// Gets the profile claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <returns>Profile claim value or null.</returns>
    internal static string? GetProfile(this ClaimsPrincipal user) => user.GetClaim(PROFILE);
    /// <summary>
    /// Adds a profile claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Profile value.</param>
    internal static ClaimsPrincipal AddProfile(this ClaimsPrincipal user, string value) => user.AddClaim(PROFILE, value);
    /// <summary>
    /// Gets the locale or language claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <returns>Locale or language claim value or null.</returns>
    internal static string? GetLocale(this ClaimsPrincipal user) => user.GetClaim(LOCALE) ?? user.GetClaim(LANGUAGE);
    /// <summary>
    /// Adds a locale claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Locale value.</param>
    internal static ClaimsPrincipal AddLocale(this ClaimsPrincipal user, string value) => user.AddClaim(LOCALE, value);
    /// <summary>
    /// Gets the expiration date/time claim as a UTC DateTime.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <returns>Expiration DateTime or null if not set or invalid.</returns>
    internal static DateTime? GetExpiration(this ClaimsPrincipal user)
    {
    ...
    internal static ClaimsPrincipal AddExpiration(this ClaimsPrincipal user, string value) => user.AddClaim(EXPIRATION, value);
    /// <summary>
    /// Gets the session identifier claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <returns>Session Id claim value or null.</returns>
    internal static string? GetSessionId(this ClaimsPrincipal user) => user.GetClaim(SESSION_ID);
    /// <summary>
    /// Adds a session identifier claim.
    /// </summary>
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Session Id value.</param>
    internal static ClaimsPrincipal AddSessionId(this ClaimsPrincipal user, string value) => user.AddClaim(SESSION_ID, value);
    /// <summary>
    ...
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Session Id value.</param>
    internal static ClaimsPrincipal AddDocument(this ClaimsPrincipal user, string value) => user.AddClaim(USER_DOCUMENT, value);
    /// <summary>
    ...
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Session Id value.</param>
    internal static ClaimsPrincipal AddAccount(this ClaimsPrincipal user, string value) => user.AddClaim(USER_ACCOUNT, value);
    /// <summary>
    ...
    /// <param name="user">The ClaimsPrincipal instance.</param>
    /// <param name="value">Session Id value.</param>
    internal static ClaimsPrincipal AddAccountCode(this ClaimsPrincipal user, string value) => user.AddClaim(USER_ACCOUNT_CODE, value);
    /// <summary>
    ...
    internal static string? GetToken(this ClaimsPrincipal user) => user.GetClaim(JWT);
    /// <summary>
    ...
    internal static ClaimsPrincipal AddToken(this ClaimsPrincipal user, string value) => user.AddClaim(JWT, value);
    /// <summary>
    ...
    internal static string? GetRefreshToken(this ClaimsPrincipal user) => user.GetClaim(RT);
    /// <summary>
    ...
    /// <returns>The updated <see cref="ClaimsPrincipal"/> with the claim added.</returns>
    internal static ClaimsPrincipal AddRefreshToken(this ClaimsPrincipal user, string value) => user.AddClaim(RT, value);
    /// <summary>
    ...
    internal static string? GetRefreshExpires(this ClaimsPrincipal user) => user.GetClaim(RT_EXP);
    /// <summary>
    ...
    /// <returns>The updated <see cref="ClaimsPrincipal"/> with the claim added.</returns>
    internal static ClaimsPrincipal AddRefreshExpires(this ClaimsPrincipal user, string value) => user.AddClaim(RT_EXP, value);
    /// <summary>
    ...
    internal static string? GetFingerprint(this ClaimsPrincipal user) => user.GetClaim(FP);
    /// <summary>
    ...
    /// <returns>The updated <see cref="ClaimsPrincipal"/> with the claim added.</returns>
    internal static ClaimsPrincipal AddFingerprint(this ClaimsPrincipal user, string value) => user.AddClaim(FP, value);
}
