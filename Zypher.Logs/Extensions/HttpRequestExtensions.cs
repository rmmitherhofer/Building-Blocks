...
internal static class HttpRequestExtensions
{
    ...
    internal static string? GetPodName(this HttpRequest request) => request.GetHeader(POD_NAME);
    ...
    internal static bool IsJsonContent(this HttpRequest request)
    ...
    internal static IDictionary<string, string> GetQueryDictionary(this HttpRequest request)
    ...
    internal static void AddOrUpdateHeader(this HttpRequest request, string key, string value)
    {
        ArgumentNullException.ThrowIfNull(request);
        ArgumentException.ThrowIfNullOrEmpty(key);
        request.Headers[key] = value;
    ...
    internal static bool IsSecureConnection(this HttpRequest request)
    ...
    internal static string GetHttpMethod(this HttpRequest request) => request.Method.ToUpperInvariant();

    /// <summary>Gets route info in the format "controller/action" if available.</summary>
    internal static string? GetRouteInfo(this HttpRequest request)
    {
    ...
    internal static bool HasBody(this HttpRequest request) => request.ContentLength > 0 || request.Body.CanRead;

    /// <summary>Checks whether the request has form content type.</summary>
    internal static bool IsFormContent(this HttpRequest request) => request.HasFormContentType;

    /// <summary>Determines if the request appears to be a webhook by header presence.</summary>
    internal static bool IsWebhookRequest(this HttpRequest request)
    ...
    internal static DateTimeOffset GetRequestStartTime(this HttpRequest request) => DateTimeOffset.UtcNow;
