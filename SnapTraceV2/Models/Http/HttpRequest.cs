...
public class HttpRequest
{
    ...
    internal HttpRequest(CreateOptions options)
    {
        ...
        ArgumentNullException.ThrowIfNullOrWhiteSpace(httpMethod, nameof(httpMethod));
    ...
    internal void SetIsAuthenticated(bool value) => IsAuthenticated = value;
    ...
    internal class CreateOptions
    {
        ...
        public CreateOptions() => StartDateTime = DateTime.UtcNow;
    }
