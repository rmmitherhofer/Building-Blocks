...
namespace SnapTraceV2.Json
{
    internal class SystemTextJsonSerializer : IJsonSerializer
    {
        ...
        {
            if (!IsJson(json, out JsonDocument document)) return [];

            SystemTextJsonDeserializeAndFlatten service = new();
        ...
        public bool IsJson(string strInput) => IsJson(strInput, out JsonDocument _);
