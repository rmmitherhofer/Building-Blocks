using SnapTrace.RestClient.HttpClient;
...
namespace SnapTrace.RestClient.Api
{
    public class PublicRestApi : IPublicApi
    {
        ...
        public ApiResult<RequestLog> CreateRequestLog(CreateRequestLogRequest request, IEnumerable<Requests.CreateRequestLog.File> files = null)
        {
        ...
        public async Task<ApiResult<RequestLog>> CreateRequestLogAsync(CreateRequestLogRequest request, IEnumerable<Requests.CreateRequestLog.File> files = null)
        {
            Uri url = Helpers.BuildUri(_baseUrl, "api/public/v1.0/createRequestLog");
            MultipartFormDataContent content = CreateMultipartFormDataContent(request, files);
        ...
        private MultipartFormDataContent CreateMultipartFormDataContent(CreateRequestLogRequest request, IEnumerable<Requests.CreateRequestLog.File> files = null)
        {
            if (request == null)
